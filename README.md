...
- **Launcher icon (fixed path)** — `cmd/sprinkl/orb/icon.svg`: must stay `cmd/<your app>/orb/icon.svg` (bundled default or your SVG).
...
**From the project name:** module `sprinkl` · on-device id `sdk.dev.sprinkl` · app folder `cmd/sprinkl`
